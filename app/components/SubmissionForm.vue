						...
						<tr>
							...
							<td>
								<el-form-item prop="itemCode">
									<el-input v-model="submissionForm.itemCode" :disabled="step!=='submission' && step!=='reject'"></el-input>
								</el-form-item>
							</td>
							<th>审计编号</th>
							<td>
						...
						<tr>
							...
							<td>
								<el-form-item prop="contractNo">
									<el-input v-model="submissionForm.contractNo" :disabled="step!=='submission' && step!=='reject'"></el-input>
								</el-form-item>
							</td>
							<th>工程项目名称<span style="color: red; ">*</span></th>
							<td>
								<el-form-item prop="projectName">
									<el-input v-model="submissionForm.projectName" :disabled="step!=='submission' && step!=='reject'" placeholder="填写工程项目名称"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
							...
							<td>
								<el-form-item prop="feeFrom">
									<el-input v-model="submissionForm.feeFrom" :disabled="step!=='submission' && step!=='reject'" placeholder="填写经费来源"></el-input>
								</el-form-item>
							</td>
							<th>预算(万元)</th>
							<td>
								<el-form-item prop="budget">
									<el-input v-model="submissionForm.budget" :disabled="step!=='submission' && step!=='reject'" placeholder="填写预算"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<el-form-item prop="constructionUnit">
									<el-input v-model="submissionForm.constructionUnit" :disabled="step!=='submission' && step!=='reject'"
						...
						<tr>
							...
							<td>
								<el-form-item prop="startDate">
									<el-date-picker v-model="submissionForm.startDate" :disabled="step!=='submission' && step!=='reject'" format="yyyy-MM-dd"
							...
							<td>
								<el-form-item prop="endDate">
									<el-date-picker v-model="submissionForm.endDate" :disabled="step!=='submission' && step!=='reject'" format="yyyy-MM-dd"
									 value-format="yyyy-MM-dd" type="date" placeholder="选择日期">
									</el-date-picker>
								</el-form-item>
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<el-form-item prop="contractMoney">
									<el-input v-model="submissionForm.contractMoney" :disabled="step!=='submission' && step!=='reject'"
						...
						<tr>
							...
							<td>
								<el-form-item prop="constructMoney">
									<el-input v-model="submissionForm.constructMoney" :disabled="step!=='submission' && step!=='reject'"
							...
							<td>
								<el-form-item prop="installMoney">
									<el-input v-model="submissionForm.installMoney" :disabled="step!=='submission' && step!=='reject'" placeholder="填写安装金额"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
							...
							<td>
								<el-form-item prop="payType">
									<el-input v-model="submissionForm.payType" :disabled="step!=='submission' && step!=='reject'" placeholder="填写工程结算方式"></el-input>
								</el-form-item>
							</td>
							<th>付款情况</th>
							<td>
								<el-form-item prop="payCondition">
									<el-input v-model="submissionForm.payCondition" :disabled="step!=='submission' && step!=='reject'" placeholder="填写付款情况"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
									...
									<tr>
										...
										<td>
											<el-form-item prop="constructionUnitApplyFee">
												<el-input v-model="submissionForm.constructionUnitApplyFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写施工单位报审金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="constructionUnitCheckFee">
												<el-input v-model="submissionForm.constructionUnitCheckFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写施工单位核减金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="constructionUnitTel">
												<el-input v-model="submissionForm.constructionUnitTel" :disabled="step!=='submission' && step!=='reject'"
									...
									<tr>
										...
										<td>
											<el-form-item prop="inspectUnitApplyFee">
												<el-input v-model="submissionForm.inspectUnitApplyFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写监理单位报审金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="inspectUnitCheckFee">
												<el-input v-model="submissionForm.inspectUnitCheckFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写监理单位核减金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="inspectUnitTel">
												<el-input v-model="submissionForm.inspectUnitTel" :disabled="step!=='submission' && step!=='reject'"
									...
									<tr>
										...
										<td>
											<el-form-item prop="buildUnitApplyFee">
												<el-input v-model="submissionForm.buildUnitApplyFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写建设单位报审金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="buildUnitCheckFee">
												<el-input v-model="submissionForm.buildUnitCheckFee" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写建设单位报审金额"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item prop="buildUnitTel">
												<el-input v-model="submissionForm.buildUnitTel" :disabled="step!=='submission' && step!=='reject'"
												 placeholder="填写建设单位报审金额"></el-input>
											</el-form-item>
										</td>
									</tr>
						...
						<tr>
							...
							<td colspan="3">
								<el-form-item prop="content">
									<el-input v-model="submissionForm.content" placeholder="填写项目内容" :disabled="step!=='submission' && step!=='reject'"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<el-form-item prop="description">
									<el-input v-model="submissionForm.description" placeholder="填写项目概况" :disabled="step!=='submission' && step!=='reject'"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<el-form-item prop="materialGroup">
									<el-select v-model="submissionForm.materialGroup" placeholder="请选择" :disabled="step!=='submission' && step!=='reject'"
									 @change="materialGroupChange">
										<el-option v-for="group in materialGroups" :key="group.id" :label="group.name" :value="group.id">
										</el-option>
									</el-select>
								</el-form-item>
							</td>
							...
							<td colspan="4" class="compact-td">
								<table class="form-table">
									...
									<tr v-for="fileType of this.submissionForm.details">
										...
										<td>
											<el-upload class="upload-demo" action="noAction" :http-request="upload" :with-credentials="true" :on-preview="handlePreview"
											 :on-remove="handleRemove" :before-remove="beforeRemove" :on-success="afterUpload" :data="uploadParams"
											 multiple :limit="3" :on-exceed="handleExceed" :file-list="fileType.mFiles">
												<el-button size="small" type="primary" class="upload-btn" v-if="step ==='submission' || step ==='reject'"
												 @click="toUpload(fileType.mId)">点击上传
												</el-button>
											</el-upload>
										</td>
										<td>
											<el-input v-model="fileType.mNote" :disabled="step!=='submission' && step!=='reject'" placeholder="填写备注"></el-input>
										</td>
									</tr>
								</table>
							</td>
						...
						<tr class="comment" v-if="step==='surveyPrepare' || step === 'auditArc' ">
							...
							<td>
								<el-form-item prop="prepareViewDate">
									<el-date-picker v-model="submissionForm.prepareViewDate" :disabled="step!=='surveyPrepare'" format="yyyy-MM-dd HH:mm:ss"
							...
							<td>
								<el-form-item prop="viewDate">
									<el-date-picker v-model="submissionForm.viewDate" :disabled="step!=='surveyPrepare'" format="yyyy-MM-dd HH:mm:ss"
									 value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="选择日期">
									</el-date-picker>
								</el-form-item>
							</td>
						...
						<tr class="comment" v-if="step==='surveyPrepare' || step === 'auditArc' ">
							...
							<td colspan="3">
								<el-form-item prop="viewPeoples">
									<el-select v-model="submissionForm.viewPeoples" style="width:700px" filterable multiple placeholder="请选择"
							...
							<td colspan="4" class="compact-td">
								<table class="form-table">
									...
									<tr v-for="fileType of this.submissionForm.surveyFiles">
										...
										<td>
											<el-upload class="upload-demo" action="noAction" :http-request="upload" :with-credentials="true" :on-preview="handlePreview"
											 :on-remove="handleRemoveSurvey" :before-remove="beforeRemoveSurvey" :on-success="afterUpload" multiple
											 :limit="3" :on-exceed="handleExceed" :file-list="fileType.mFiles">
												<el-button size="small" type="primary" class="upload-btn" v-if="step ==='survey'" @click="toUpload(fileType.mId)">点击上传
												</el-button>
											</el-upload>
										</td>
										<td>
											<el-input v-model="fileType.mNote" :disabled="step!=='survey'" placeholder="填写备注"></el-input>
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="4" class="compact-td">
								<table class="form-table">
									...
									<tr v-for="fileType of this.submissionForm.argueFiles">
										...
										<td>
											<el-upload class="upload-demo" action="noAction" :http-request="upload" :with-credentials="true" :on-preview="handlePreview"
											 :on-remove="handleRemoveArgue" :before-remove="beforeRemoveArgue" :on-success="afterUpload" multiple :limit="3"
											 :on-exceed="handleExceed" :file-list="fileType.mFiles">
												<el-button size="small" type="primary" class="upload-btn" v-if="step ==='argueHandle'" @click="toUpload(fileType.mId)">点击上传
												</el-button>
											</el-upload>
										</td>
										<td>
											<el-input v-model="fileType.mNote" :disabled="step!=='argueHandle'" placeholder="填写备注"></el-input>
										</td>
									</tr>
								</table>
							</td>
						...
						<tr v-if="step === 'auditFirst' || step === 'auditArc' ">
							...
							<td>
								<el-form-item prop="submissionPrice">
									<el-input v-model="submissionForm.submissionPrice" :disabled="step!=='auditFirst'" placeholder="填写送审价"></el-input>
								</el-form-item>
							</td>
							<th>初审审定金额</th>
							<td>
								<el-form-item prop="firstAuditPrice">
									<el-input v-model="submissionForm.firstAuditPrice" :disabled="step!=='auditFirst'" placeholder="填写土建金额"></el-input>
								</el-form-item>
							</td>
						</tr>
						...
						<tr v-if="step === 'auditSecond' || step === 'auditArc' ">
							...
							<td colspan="3">
								<el-form-item prop="secondAuditPrice">
									<el-input v-model="submissionForm.secondAuditPrice" :disabled="step!=='auditSecond'" placeholder="填写复审审定金额"></el-input>
								</el-form-item>
							</td>
						</tr>
							...
							<td colspan="4" class="compact-td">
								<table class="form-table">
									...
									<tr v-for="fileType of this.submissionForm.auditFirstFiles">
										...
										<td>
											<el-upload class="upload-demo" action="noAction" :http-request="upload" :with-credentials="true" :on-preview="handlePreview"
											 :on-remove="handleRemoveAuditFirst" :before-remove="beforeRemoveAuditFirst" :on-success="afterUpload"
											 multiple :limit="3" :on-exceed="handleExceed" :file-list="fileType.mFiles">
												<el-button size="small" type="primary" class="upload-btn" v-if="step ==='auditFirst'" @click="toUpload(fileType.mId)">点击上传
												</el-button>
											</el-upload>
										</td>
										<td>
											<el-input v-model="fileType.mNote" :disabled="step!=='auditFirst'" placeholder="填写备注"></el-input>
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="4" class="compact-td">
								<table class="form-table">
									...
									<tr v-for="fileType of this.submissionForm.auditSecondFiles">
										...
										<td>
											<el-upload class="upload-demo" action="noAction" :http-request="upload" :with-credentials="true" :on-preview="handlePreview"
											 :on-remove="handleRemoveAuditSecond" :before-remove="beforeRemoveAuditSecond" :on-success="afterUpload"
											 multiple :limit="3" :on-exceed="handleExceed" :file-list="fileType.mFiles">
												<el-button size="small" type="primary" class="upload-btn" v-if="step ==='auditSecond'" @click="toUpload(fileType.mId)">点击上传
												</el-button>
											</el-upload>
										</td>
										<td>
											<el-input v-model="fileType.mNote" :disabled="step!=='auditSecond'" placeholder="填写备注"></el-input>
										</td>
									</tr>
								</table>
							</td>
	...
	export default {
		...
		methods: {
			commit: function(event) {
				if (this.step === 'submission' || this.step === 'reject' || this.step === 'surveyPrepare' || this.step ===
